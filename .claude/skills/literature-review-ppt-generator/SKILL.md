...
description: "为学术论文生成5分钟文献汇报PPT内容（严格2页）。当用户上传PDF论文并要求制作文献汇报、组会汇报、论文分享、paper presentation、读论文做PPT时触发。输出 paper_summary.md（论文总结）和 ppt_content.md（PPT内容）。"
---
...
| 幻灯片 | 总行数范围 | 说明 |
|--------|-----------|------|
| **Slide 1** | **15 ~ 18 行** | 超出 18 行必须删减 |
| **Slide 2** | **17 ~ 21 行** | 超出 21 行必须删减 |
...
### 2. 设计大纲
选择合适的逻辑流程，规划**严格2页**内容，撰写精炼的英文描述。草稿写完后，统计每页内容行数，超出上限则删减低价值内容。
